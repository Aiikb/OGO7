...
#dataF = varFilter(eset,var.func=IQR, var.cutoff=0.5, filterByQuantile=TRUE)  #filter data by percentile variance

write.exprs(dataF,file="Processed data/50varfiltereddata.txt")				# write to file and log2 transform
